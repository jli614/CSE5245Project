...
python bespoke-multiplex-weighted/combine_graph.py MyGraph_edgelist_layer0.txt MyGraph_edgelist_layer1.txt \
                                          --out MyGraph_edgelist_layer_combined.txt


python bespoke-multiplex-weighted/label_nodes.py MyGraph_edgelist_layer_combined.txt 5 MyGraph_labels.txt
python bespoke-multiplex-weighted/run_bespoke.py MyGraph_edgelist_layer_combined.txt MyGraph_training.txt 25 \
                                                 MyGraph_labels.txt MyGraph_bespoke.txt --eval_src MyGraph_communities.txt

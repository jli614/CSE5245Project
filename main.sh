...
python bespoke-multiplex/label_nodes_multiplex.py MyGraph_edgelist_layer{i}.txt 3 10 MyGraph_labels.txt
python bespoke-multiplex/run_bespoke_multiplex.py MyGraph_edgelist_layer{i}.txt 3 MyGraph_training.txt 500 \
                                        MyGraph_labels.txt MyGraph_bespoke.txt --eval_src MyGraph_communities.txt
